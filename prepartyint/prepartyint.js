...
function displayFirstPopup() {
    const firstPopup = new Popup('Beer Pong! My favorite','Start','/prepartyext/prepartyext.html');
...
function testForWin() {
    if (cupsHit === 6) {
        const winPopup = new Popup('Score! I/m totally in a party mode now!','','/prepartyext/prepartyext.html');
